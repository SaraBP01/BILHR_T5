...
class SimpleCMAC:
    def __init__(self, input_dims=2, output_dims=2, resolution=50, receptive_field=3):
        ...
        # Initialize weight matrix with pre-trained-like weights with Gaussian distribution
        self.weights = np.random.normal(0, 0.1, (self.total_cells, output_dims))
        
        # Normalization parameters for camera input
...
class RobotCMACController(Node):
    def __init__(self):
        ...
        # Initialize robot joint controller 
        ...
        # Joint angle contraints for safety
        self.joint_limits = {
            'l_sho_roll': (-1.5, 0.5),   # Left shoulder roll 
            'l_sho_pitch': (-1.5, 1.8),  # Left shoulder pitch 
        }
    ...
    def apply_safety_limits(self, joint_positions):
        """Safety limits to prevent dangerous joint positions"""
